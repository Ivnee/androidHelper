package com.geek.lection1.LayoutTypes3;
...
public class Layouts extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_otladka);


        //Лейауты
        RelativeLayout relativeLayout;//по сторонам света либо относительно других элементов
        GridLayout gridLayout;//orientation задаем и указывает количество колонок columnCount="4"
        // когда набирает 4 элемента в колонке ,переносит на следующую + команды к вьюхам rowSpan columnSpan спан - это отступ
        TableLayout tableLayout;// orientation="horizontal" </TableRow> пихаем в строку вьюхи</>
        LinearLayout linearLayout;// orientation: horizontal ,vertical  в самом лейауте
        //layout_weight="1" в вьюхаъ
        FrameLayout frameLayout;//отображает с левого вернего угла друг над другом
        // Команды лейаута  (layout_gravity(двигает сам контейнер)="end| center_vertical" , layout_marginTop="20dp" ,
        // gravity="centre" двигает сам контент
        ScrollView scrollView;//для прокручивания элементов


        //ПОДРОБНО
/*
            FrameLayout — базовый контейнер для многих макетов, создан для хранения одного элемента.GRAVITY
            ...
            CoordinatorLayout — элементы могут взаимодействовать в этом макете.
