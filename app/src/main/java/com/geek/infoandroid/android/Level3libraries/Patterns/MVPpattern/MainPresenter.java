...
import com.geek.infoandroid.android.Level3libraries.Patterns.MVPpattern.base.BasePresenter;
//бейс презентд для аттача и детача вьюхи, мэинн контракт презентр для обозночения что это презентр
