package com.geek.infoandroid.android.Level2.les6.Push;
...
public class PushComments {
    ...
    3)добавляем наше приложение
           ...
           д) добавляем в манифест <service android:name="com.geek.infoandroid.android.Level2.les6.Push.MyFirebase">
                                        <intent-filter>
