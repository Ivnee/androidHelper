package com.geek.infoandroid.android.Level2.les1;
...
/*В НАВИГАЦИИ И В МЕНЮ ИМЕНА ЭЛЕМЕНТОВ ДОЛЖНЫ БЫТЬ ОДИНАКОВЫМИ
    <navigation
        ...
        android:name="com.geek.infoandroid.android.Fragments5.Fragment1"//определяем сам фрагмент
        ...
        <fragment //2)
        android:id="@+id/frag2"
        android:name="com.geek.infoandroid.android.Fragments5.Fragment2"
        android:label="home2"
