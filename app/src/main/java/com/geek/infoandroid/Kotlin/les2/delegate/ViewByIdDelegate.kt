package com.geek.infoandroid.Kotlin.les2.delegate
...
//как вызывается через экстеншены

//private val searchFab by viewById<FloatingActionButton>(R.id.search_fab)


//как вызывается без экстеншанов
/*
private val serchfab by ViewByIdDelegate<FloatingActionButton>({
